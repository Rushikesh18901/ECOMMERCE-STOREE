...
export default function ProductDetail() {
    ...
    return (
        <div className="p-10 grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
            ...
            <button
                onClick={() => navigate(-1)}
                className="col-span-full mb-4 text-gray-600 hover:text-black flex items-center gap-2 w-fit"
            >
                ← Back to Products
            </button>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex gap-2 flex-wrap">
                            {product.size.map((s, i) => (
                                <span key={i} className="border border-gray-300 px-3 py-1 rounded hover:bg-gray-100 cursor-pointer">
                                    {s}
                                </span>
                            ))}
                        </div>
